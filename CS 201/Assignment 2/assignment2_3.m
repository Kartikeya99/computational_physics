...
title('Computational vs Analytical comparison of Position vs Time for air r=0.1, m=0.5');
...
title('Computational vs Analytical comparison of Position vs Time for water r=0.1, m=0.5');
xlabel('Time in seconds');
ylabel('Position of the body in meters');
legend('Computational Solution', 'Analytical Solution');